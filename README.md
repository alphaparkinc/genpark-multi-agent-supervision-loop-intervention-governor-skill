# genpark-multi-agent-supervision-loop-intervention-governor-skill
...
> **GenPark AI Agent Skill** -- Multi-agent supervision supervisor & loop intervention governor (Omni style)
